...
export class Application {
  ...
  constructor() {
    ...
    this.server = this.app.listen(process.env.PORT, () => {
      ...
      console.log(`GraphQL running on http://localhost:${process.env.PORT}/graphql`);
      console.log(`Docs running on http://localhost:${process.env.PORT}/api-docs`);
    });
    this.socket();
  }
  ...
  private routes(): void {
    ...
    this.app.use('/model', modelRoutes);
  }
